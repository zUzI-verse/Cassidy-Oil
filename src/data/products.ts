...
const products: Product[] = [
  {
    ...
    image: FrameF,
    // isPremium: true,
     productBenefits:[ "Enhanced protection of engine parts at the point of engine start up.", 
          "Reduced propensity of sludge deposits which ensures superior engine cleanliness during normal operation.",
          "Reduced propensity of oil thickening and oxidation thereby reducing oil consumption under normal operating conditions.",
          "Reduced Disc wear and Valve Train wear.",
          "Excellent corrosion protection, even when engine is off."],
  ...
  },
  {
    ...
    image: FrameG,
    // isPremium: false,
     productBenefits:[ "Resistance to oil oxidation and thermal degradation thereby increasing oil life.", 
          "Enhanced engine life and protects engine parts at the point of engine start up.",
          "Increased engine cleanliness by using advanced detergent- dispersant additive technology.",
          "Multigrade performance advantage which allows excellent oil performance in wide operating temperature.",
          "Excellent corrosion protection, even when engine is off.", "Provides excellent protection in prolonged city stop-and-go driving conditions."],
  ...
  },
  {
    ...
    image: FrameO,
    // isPremium: true,
    productBenefits:[ " Excellent results in high temperature sludge reduction to ensure engine cleanliness.", "Remarkable resistance to engine wear is normal and adverse operating condition.", "Reduced propensity of aeration thereby reducing the formation of foams at high engine rotation speed which in turn ensures lubrication to critical engine parts.", "Enhanced wear protection to various critical engine parts such as cylinder liner, piston rings, valves, cams etc. which increases engine life.", "Multigrade oil advantage which protects engine parts at the point of engine start up.", "Optimal oil performance even at higher engine operating load and temperature.", "Reduced propensity of oil thickening and oxidation thereby reducing oil consumption under normal operating conditions.", "Excellent corrosion protection, even when engine is off."],
  ...
  },
  {
    ...
    image: FrameS,
    // isPremium: false,
     productBenefits:[ "Maximises short- and long-term engine performance.", 
          "Delivers unsurpassed protection across low temperature and other demanding operating conditions.",
          "Excellent results in high temperature sludge reduction to ensure engine cleanliness.",
          "Remarkable resistance to engine wear is normal and adverse operating condition.",
          "Enhanced wear protection to various critical engine parts such as cylinder liner, piston rings, valves, cams etc. which increases engine life.", "Multigrade oil advantage which protects engine parts at the point of engine start up.",
          "Optimal oil performance even at higher engine operating load and temperature.",
          "Reduced propensity of oil thickening and oxidation thereby reducing oil consumption under normal operating conditions.",
          "Excellent corrosion protection, even when engine is off."],
  ...
  },
  {
    ...
    image: FrameR,
    // isPremium: false,
      productBenefits:[ "Maximises short- and long-term engine performance.", "Delivers unsurpassed protection across low temperature and other demanding operating conditions.", "", "Excellent results in high temperature sludge reduction to ensure engine cleanliness.", "Remarkable resistance to engine wear is normal and adverse operating condition.", "Enhanced wear protection to various critical engine parts such as cylinder liner, piston rings, valves, cams etc. which increases engine life.", "Multigrade oil advantage which protects engine parts at the point of engine start up.", "Optimal oil performance even at higher engine operating load and temperature.", "Reduced propensity of oil thickening and oxidation thereby reducing oil consumption under normal operating conditions.", "Excellent corrosion protection, even when engine is off."],
